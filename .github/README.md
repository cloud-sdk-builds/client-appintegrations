...
[`@aws-sdk/client-appintegrations`](https://www.npmjs.com/package/@aws-sdk/client-appintegrations/v/3.2.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appintegrations@3.2.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8oZEL4blEs1N9kI0olEQmRe1g98e3kIY4opiAMvhdLYSLQcNbCeNT3chEFuzyVkS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-appintegrations": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appintegrations@3.2.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appintegrations@3.2.0/index.min.mjs": "sha384-8oZEL4blEs1N9kI0olEQmRe1g98e3kIY4opiAMvhdLYSLQcNbCeNT3chEFuzyVkS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-appintegrations/blob/refs/tags/3.2.0/LICENSE
```
